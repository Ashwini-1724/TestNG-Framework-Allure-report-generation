...
public class Utilitycommonfunction {
	...
	public static void evidencefilecreator(String filename, String requestBody, String responseBody)
			throws IOException {
		File newfile = new File("C:\\Users\\Ashwini\\Documents\\Rest Assured Assignments" + "\\" + filename + ".txt");
	...
	public static ArrayList<String> readdataexcel(String sheetname, String testcasename) throws IOException {
		...
		FileInputStream fis = new FileInputStream(
				"C:\\Users\\Ashwini\\Documents\\" + "Rest Assured Assignments\\API_test data.xlsx");
